...
const EditSalaryDetails = () => {
  ...
  return (
    <div className="salary-details layout   w-full p-[20px] pt-[80px] xl:p-[40px] relative xl:pt-[100px]    xl:pl-[320px] flex flex-col">
      <div className="flex items-center justify-between  pb-6 max-[1050px]:block">
