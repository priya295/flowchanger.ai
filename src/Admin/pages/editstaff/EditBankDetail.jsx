                ...
                <div className='flex w-[100%] gap-[10px] justify-between  xl:mb-4 mb-[6px] xl:flex-row flex-col'>
                    ...
                    <div className='w-[100%]  xl:w-[48%] 2xl:w-[48%] '>
                        ...
                        <input
                            ...
                            readOnly={!isEditable1}
                            style={{
                                backgroundColor: isEditable1 ? "#f4f5f9" : "#fff",
                                border: isEditable1 ? "1px solid #F4F5F9" : '#000'
                            }}
                            className=' rounded-md p-[5px] mt-1 w-[100%] bg-[#F4F5F9] focus:outline-none text-[#000] placeholder:font-font-normal text-[14px]'
                        />
                    </div>
                ...
                <div className='flex w-[100%] gap-[10px] justify-between  xl:mb-4 mb-[6px] xl:flex-row flex-col'>
                    ...
                    <div className='w-[100%]  xl:w-[48%] 2xl:w-[48%] '>
                        ...
                        <input
                            ...
                            readOnly={!isEditable4}
                            style={{
                                backgroundColor: isEditable4 ? "#f4f5f9" : "#fff",
                                border: isEditable4 ? "1px solid #F4F5F9" : '#000'
                            }}
                            className=' rounded-md p-[5px] mt-1 w-[100%] bg-[#F4F5F9] focus:outline-none text-[#000] placeholder:font-font-normal text-[14px]'
                        />
                    </div>
                    ...
                    <div className='w-[100%]  xl:w-[48%] 2xl:w-[48%] '>
                        <label className='text-[14px]'>Name of Account Holder</label><br />
                        <input
                            type="text"
                            value={inputValue5}
                            onChange={handleInputChange5}
                            readOnly={!isEditable5}
                            style={{
                                backgroundColor: isEditable5 ? "#f4f5f9" : "#fff",
                                border: isEditable5 ? "1px solid #F4F5F9" : '#000'
                            }}
                            className=' rounded-md p-[5px] mt-1 w-[100%] bg-[#F4F5F9] focus:outline-none text-[#000] placeholder:font-font-normal text-[14px]'
                        />
                    </div>
