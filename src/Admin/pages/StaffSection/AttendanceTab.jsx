    ...
    <div className="attendance-tab mt-[20px]">
      ...
      >
        <h2
          ...
          className="border-b p-3   border-[#000]"
        >
            ...
            <div className="first-panel">
              <table className="w-full">
                <thead className="border-b border-[#000] ">
                  ...
                  <th className="p-3 text-base font-medium w-[45px]">
                    Weekoff{" "}
                  </th>
                  <th className="p-3 text-base font-medium text-left">
                    Shifts
                  </th>
                </thead>
                <tbody>
                  <tr className="">
                    ...
                    <td className="pr-5">
                      <select
                        onClick={openModal1}
                        className="border border-1 rounded-md p-[5px] mt-1 w-[94%] bg-[#F4F5F9] focus:outline-none text-[#000] placeholder:font-font-normal text-[14px]"
                      >
      ...
      >
        ...
        <div>
          ...
          <Link
            to=""
            className="text-[#511992] p-4 font-medium mt-3 block w-full	"
          >
            <AddIcon /> Add Shift
          </Link>
          <br />
