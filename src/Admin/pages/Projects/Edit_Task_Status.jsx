                    ...
                    <table className="w-full">
                        <thead>
                            <tr>
                                ...
                                <th className="text-[12px] h-[12px] font-medium p-[10px] w-[50px] border-r whitespace-nowrap" >ID</th>
                                ...
                                <th className="text-[11px] font-medium p-[10px] w-[110px] border-r whitespace-nowrap">Status Color</th>
                                <th className="text-[11px] font-medium p-[10px] w-[110px] border-r whitespace-nowrap">Status Order</th>


                                <th className="text-[11px] font-medium p-[10px] w-[150px] border-r whitespace-nowrap	">Status default filter</th>
