    ...
    return (
        <div className='mt-[20px]'>
          ...
          <Modal
            ...
            >
                <h2 ref={(_subtitle) => (subtitle = _subtitle)} className='border-b p-3     text-[14px] text-center bg-[#F0F6FE] rounded-t-lg rounded-r-lg rounded-b-none'>Import Incentives for all Staff
                </h2>
