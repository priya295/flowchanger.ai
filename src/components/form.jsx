  ...
  return (
    <div className="container mx-auto px-4 max-w-5xl">
      <div className="flex flex-col space-y-6">
        <div className=' flex  h-10 justify-evenly items-center xs:w-full md:w-[12%] '>
        <FaArrowLeft/><span className='font-bold'>Add staff</span>
        </div>
        <hr/>
        ...
        <form className="w-full mt-5">
          {[
            ...
            <div key={index} className="mb-6 flex  w-screen mx-auto">
              <label className="block text-gray-500 font-bold mb-2 w-[10%]" htmlFor={`field-${index}`}>
                {field.label}
              </label>
              <input
