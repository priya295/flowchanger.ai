...
const SideBar = ({ toggleSideBar }) => {
  ...
  return (
    ...
    <div className="sidebar flex-shrink-0 w-[100%] xl:w-[20%] lg:w-[20%] md:w-[300px] bg-[#27004a] h-full p-[10px] transition-all duration-300 ease-in-out">
      ...
      <ul className="pl-[2px] pr-[2px] pt-[0px] pb-[20px]">
        <li onClick={() => { setSelectedSidebarTab("dashboard") }} className={`flex items-center gap-[10px] hover:bg-[#fff] hover:text-[#8a25b0] p-[10px]  rounded-md  transition-all ${selectedSidebarTab === "dashboard" ? "bg-white text-[#8a25b0]" : "text-white"}`}>
          {/* <img src={home} /> */}
          <HomeIcon />
        ...
        <div className="">
          <Link to="/projects" className={`flex items-center gap-[10px]  p-[10px] hover:bg-[#fff] rounded-md hover:text-[#8a25b0] transition-all ${selectedSidebarTab === "project" ? "bg-white [#8a25b0] text-[#8a25b0]" : "text-white"}`} onClick={() => { setSelectedSidebarTab("project") }}>
            {/* <img src={project} alt="" /> */}
