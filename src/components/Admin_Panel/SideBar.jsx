  ...
  return (
    ...
    <div className="sidebar w-[100%] xl:w-[20%] lg:w-[20%] md:w-[300px] bg-[#27004a] h-full p-[10px]">
      ...
      <ul className="pl-[2px] pr-[2px] pt-[0px] pb-[20px]">
        ...
        <div className="">
          <Link to="/projects" className={`flex items-center gap-[10px] mb-[5px]  p-[10px] hover:bg-[#fff] rounded-md hover:text-[#8a25b0] transition-all ${selectedSidebarTab === "project" ? "bg-white [#8a25b0] text-[#8a25b0]" : "text-white"}`} onClick={() => { setSelectedSidebarTab("project") }}>
            {/* <img src={project} alt="" /> */}
        ...
        <div className="">
          <Link to="/task" onClick={() => { setSelectedSidebarTab("task") }} className={`flex items-center gap-[10px]  p-[10px] hover:bg-[#fff] rounded-md hover:text-[#8a25b0] transition-all ${selectedSidebarTab === "task" ? "bg-white text-[#8a25b0]" : "text-white"}`}>
            {/* <img src={task} alt="" /> */}
...
{/* 
        ...
        <div className="">
          <Link to="/clients" className={`flex items-center gap-[10px] p-[10px] hover:bg-[#fff] rounded-md hover:text-[#8a25b0] transition-all ${selectedSidebarTab === "clients" ? "bg-white text-[#8a25b0]" : "text-white"}`} onClick={() => { setSelectedSidebarTab("client")  }}>
            {/* <img src={client} alt="" /> */}
  ...
  {activeSubmenu && (
    <div className="transition-all duration-300 ease-in-out mt-[5px] overflow-hidden">
      <div>
        <Link
          to="/payroll-menu"
          onClick={() => setSelectedSidebarTab("payroll")}
          className={`w-full text-left py-[10px] flex items-center gap-[10px] pl-[40px] whitespace-nowrap transition-all rounded-md overflow-hidden ${
            selectedSidebarTab === "payroll" ? "bg-white text-[#8a25b0]" : "text-white"
          }`}
        >
          <ArrowForwardIosIcon className="arrow-icon-sidebar" />
          Payroll
      ...
      <div>
        <Link
          ...
          className={`w-full text-left py-[10px] flex items-center gap-[10px] pl-[40px] whitespace-nowrap transition-all rounded-md overflow-hidden ${
            selectedSidebarTab === "attendance" ? "bg-white text-[#8a25b0]" : "text-white"
          }`}
        >
          <ArrowForwardIosIcon className="arrow-icon-sidebar" />
          Attendance
        ...
        <div className="">
          <Link onClick={() => { setSelectedSidebarTab("role") }} to="/role-detail" className={`flex items-center gap-[10px]  p-[10px] hover:bg-[#fff] rounded-md hover:text-[#8a25b0] transition-all ${selectedSidebarTab === "role" ? "bg-white text-[#8a25b0]" : "text-white"}`}>
            {/* <img src={staff} alt="" /> */}
        ...
        <div className="">
          <Link to="/department-details" onClick={() => { setSelectedSidebarTab("department") }} className={`flex items-center gap-[10px]  p-[10px] hover:bg-[#fff] rounded-md hover:text-[#8a25b0] transition-all ${selectedSidebarTab === "department" ? "bg-white text-[#8a25b0]" : "text-white"}`}>
            {/* <img src={staff} alt="" /> */}
        ...
        <div className="mt-[5px] mb-[5px]">
          <Link onClick={() => { setSelectedSidebarTab("subscription-plan") }} to="/subscription-plan" className={`flex items-center gap-[10px]  p-[10px] hover:bg-[#fff] rounded-md hover:text-[#8a25b0] transition-all ${selectedSidebarTab === "subscription-plan" ? "bg-white text-[#8a25b0]" : "text-white"}`}>
            {/* <img src={staff} alt="" /> */}
        ...
        <div className="">
          {/* <div onClick={() => { selectedSidebarTab("settings") }} className={`flex items-center gap-[10px]  p-[10px] hover:bg-[#fff] rounded-md hover:text-[#8a25b0] transition-all ${selectedSidebarTab === "settings" ? "bg-white text-[#8a25b0]" : "text-white"}`}>
