      ...
      <div class="flex space-x-6  shadow-lg rounded-lg p-6 h-full parent-container bg-white">
        ...
        <div className="flex flex-row justify-start items-center space-x-3 border-b  pb-5 mb-2">
          ...
          <div class="mb-4 w-full md:w-[80%]   grid grid-cols-3  ">
           ...
           <div className="p-3 flex justify-start items-center text-gray-400 hover:text-black" onClick={()=>{setChatTab("clients")}}>Clients
           </div>
          </div>
          <div className="w-full h-full flex-grow flex flex-col justify-between space-y-2">
           {chatTab === "staff" ? <Staff handleShowChatSection={handleShowChatSection} handleSelectedStaff={handleSelectedStaff}/> : chatTab === "clients" ? <Clients handleShowChatSection={handleShowChatSection} handleSelectedStaff={handleSelectedStaff}/> :  <Groups handleShowChatSection = {handleShowChatSection} />}
           </div>
