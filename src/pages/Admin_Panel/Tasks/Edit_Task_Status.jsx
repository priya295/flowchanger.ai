    ...
    const accordionItems = [
        {
                    ...
                    <table className="w-full">
                        <thead>
                            <tr>
                                ...
                                <th className="text-[12px] h-[12px] text-center font-medium p-[10px] w-[50px] border-r whitespace-nowrap" >ID</th>



                                <th className="text-[11px] w-[130px] text-center p-[10px] border-r font-medium whitespace-nowrap">Status Name</th>


                                <th className="text-[11px] font-medium text-center p-[10px] w-[110px] border-r whitespace-nowrap">Status Color</th>
                                <th className="text-[11px] font-medium text-center p-[10px] w-[110px] border-r whitespace-nowrap">Status Order</th>


                                <th className="text-[11px] font-medium text-center p-[10px] w-[150px] border-r whitespace-nowrap	">Status default filter</th>



                                <th className="text-[11px] font-medium text-center p-[10px] w-[300px] border-r whitespace-nowrap	">Status can be changed to</th>
                                <th className="text-[11px] font-medium text-center p-[10px] w-[148px]  whitespace-nowrap	">Status is hidden for</th>
            ...
            content: (
                <table className="w-full " >
                    <tbody>
                        <tr>
                            <td className="text-[12px] h-[12px] font-medium text-center p-[10px] w-[50px]  whitespace-nowrap" >1</td>
                            <td className="text-[11px] w-[130px] p-[10px] text-center font-medium whitespace-nowrap">Not Started</td>
                            <td className="text-[11px] font-medium p-[10px] text-center w-[110px]  whitespace-nowrap">#000000</td>
                            <td className="text-[11px] font-medium p-[10px] text-center w-[110px] whitespace-nowrap">20</td>
                            <td className="text-[11px] font-medium p-[10px] text-center w-[150px]  whitespace-nowrap">yes</td>
                            <td className="text-[11px] font-medium p-[10px] text-center w-[300px]  whitespace-nowrap"><Link className="text-[white] rounded-lg p-[8px] bg-[#27004a]" to="/">in Progress</Link></td>
                            <td className="text-[11px] justify-center  flex items-center gap-[5px] font-medium p-[10px] w-[148px]  whitespace-nowrap	">

                                <div className="flex items-center justify-center text-[14px] h-[50px]">
                                    {/* Button to open the modal */}
                                    <button
                                        onClick={toggleModal3}
                                        className="newone-btn p-[8px] bg-[#8a25b0] text-[white] rounded-lg"
                                    >
                                        Edit
                                    </button>
                                    ...
                                    {isOpen3 && (
                                        <div className="fixed inset-0 flex items-center p-[10px]  justify-center bg-gray-800 bg-opacity-50">
                                            <div className="bg-white rounded-lg shadow-cs w-[35%] overflow-scroll h-[100%]">
                                                {/* Modal Header */}
                                ...
                                <button className="p-[8px] bg-[red] text-[white] rounded-lg">Delete</button>
                            </td>
                ...
                <div className="p-[20px] summary-border w-full">
                    ...
                    <div className="flex items-center gap-[14px] mb-[10px]">
                        <div className="flex items-center justify-center text-[14px] h-[50px]">
                            ...
                            {/* Modal (visible only when isOpen is true) */}
                            {isOpen && (
                                <div className="fixed inset-0 flex items-center inse-grey justify-center bg-gray-800 bg-opacity-50">
                                    <div className="bg-white rounded-lg shadow-cs w-96">
                                        {/* Modal Header */}
                                        <div className="px-4 py-2 border-b">
                    ...
                    {accordionItems.map((item, index) => (
                        <div key={index} className="bg-white shadow-cs rounded-lg  ">
                            {/* Accordion Header */}
                            <button
                                onClick={() => handleToggle(index)}
                                className="flex justify-between items-center w-full text-left border border-[#e5e7eb]  bg-white rounded-lg shadow-cs focus:outline-none"
                            >
