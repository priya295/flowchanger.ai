...
return (
  <div className="p-4 bg-white shadow-lg rounded-md">
    ...
    <Link
          ...
          className="text-white text-sm bg-[#27004a]  rounded-lg px-4 py-2 flex items-center gap-2 w-[150px]"
        >
          <AddIcon /> New Project
        </Link>
    </div>
...
<div className='flex mb-4 justify-between p-3 flex-col gap-2  sm:flex-row sm:gap-0'>
    ...
    <div className="relative client-add">
        <input type='text' placeholder='Search...' className="p-[6px] client-add  rounded-2xl pl-[10px] pr-[24px] focus-visible:outline-none  summary-border text-[13px] "
 />
